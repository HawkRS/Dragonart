...
"Dragon Art" tiene como propósito ser un espacio para que artistas, apasionados 
o aficionados al dibujo puedan compartir sus creaciones con todas las personas que
visiten este sitio. Se tendrán dos formas de utilizar la plataforma:


Usuarios registrados
--------------------
El registro se realizará mediante la conexión a redes sociales o llenando un formulario
con la información básica (nombre de usuario, contraseña, correo electrónico). Al terminar el registro,
recibirán un correo de confirmación para validar los datos que fueron ingresados, terminando así
